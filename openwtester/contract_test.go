...
func TestSmartContractTransaction_ABI(t *testing.T) {
	...
	callParam := []string{
		...
		"577109169200119870333",
		"c778417e063141139fce010982780140aa0cd5ab,471483d78a0940bcfd38efb4a8cc017e285bd417",
		"0xae3603dc4b216f91fadb82f7bd760e7ea08466be",
		"1599885738",
	}

	rawTx, err := tm.CreateSmartContractTransaction(testApp, walletID, accountID, "0.003", "", &contract, callParam, "", 0)
	if err != nil {
...
func TestSmartContractTransaction_RAW(t *testing.T) {
	...
	//value := common.StringNumToBigIntWithExp("0.0003", 18)
	//data, _ := hexutil.Decode("")
	//
	//raw := &quorum.CallMsg{
	//	From:  ethcom.HexToAddress("0xae3603dc4b216f91fadb82f7bd760e7ea08466be"),
	//	To:    ethcom.HexToAddress("0x7a250d5630b4cf539739df2c5dacb4c659f2488d"),
	//	Data:  data,
	//	Amount: value,
	//}
	...
	rawJSON := `{"gas":"0x25261","value":"0xb5e620f48000","from":"0xae3603dc4b216f91fadb82f7bd760e7ea08466be","to":"0x7a250d5630b4cf539739df2c5dacb4c659f2488d","data":""}`

	rawTx, err := tm.CreateSmartContractTransaction(testApp, walletID, accountID, "0", "", &contract, nil, rawJSON, 1)
	if err != nil {
		t.Errorf("CreateSmartContractTransaction failed, unexpected error: %v", err)
		return
	}
