...
func testNewWalletManager() *WalletManager {
	...
	//读取配置
	absFile := filepath.Join("conf", "TESTETH.ini")
...
func TestWalletManager_GetAddrBalance(t *testing.T) {
	...
	balance, err := wm.GetAddrBalance("0xfe6e2c31ebfe92562ad4280c78bef60c5ea7a72b", "pending")
	if err != nil {
...
func TestWalletManager_GetTransactionCount(t *testing.T) {
	wm := testNewWalletManager()
	count, err := wm.GetTransactionCount("0xc36eef576210a7850d73de2d7a1523123ba0cfdb")
	if err != nil {
